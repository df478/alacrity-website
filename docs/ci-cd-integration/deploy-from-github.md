...
NOTE: AlaCrity server must be in the format of "https://alacran.apps.your-domain.com". You can set ALACRITY_SERVER as a Global Secret for all your private and/or public projects.
