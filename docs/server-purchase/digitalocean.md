---
id: digitalocean
title: Setting AlaCrity Up With DigitalOcean
sidebar_label: DigitalOcean
---


If this is your first time setting up a server, DigitalOcean is probably the easiest solution for you. 
...
At this point you are logged into your server and you can run alacran installer as explained in Getting Started section.
